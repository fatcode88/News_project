                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        <?php
                          foreach ($data as $k) {
                            echo "<tr>
                          <td>{$k['registation_date']}</td>
                          <td>{$k['name']}</td>
                          <td>{$k['user_name']}</td>
                          <td>{$k['email']}</td>
                          <td>{$k['active']}</td>
                           <td>
                           <a href='./edituser.php?id={$k['user_id']}'><img src='./images/edit.png' alt=Edit></a>
                         </td>
                         <td>
                         <a href='./delete_user.php?id={$k['user_id']}'><img src='./images/delete.png' alt='Delete' name='delete'></a>
                        </td>
                         </tr>";
                        }   
                          ?>
