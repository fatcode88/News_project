                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <?php
                         ...
                         <td>
                         <a href='./editCategory.php?id={$k['category_id']}'><img src='./images/edit.png' alt='Edit' name='edit'></a>
                         </td>
                         <td>
                         <a href='./delete_category.php?id={$k['category_id']}'><img src='./images/delete.png' alt='Delete' name='delete'></a>
                        </td>
                        </tr>";
                       }   
                        ?>
