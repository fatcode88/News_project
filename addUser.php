...
if (isset($_POST['add'])) {
  ...
  $date = date('Y-m-d');
  if (!empty($full_name) && !empty($user_name) && !empty($email) && !empty($active) && !empty($pass) && !empty($image)) {
    $query = "INSERT INTO users(name,user_name,email,active,password,user_image,registation_date)
    VALUES('$full_name','$user_name','$email','$active','$pass','$image','$date')";
         $conn->exec($query);
         echo "<br>User Inserted successfuly"; 
  }
}
?>
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" required="required" name="f_name" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="file" id="password" name="user_image" required="required" class="form-control">
											</div>
										</div>
