...
if (isset($_POST['update'])) {
  ...
  $active = isset($_POST['active'])? 'Yes': 'No';
   ...
   if (!empty($full_name) && !empty($user_name) && !empty($email) && !empty($pass) && !empty($image) && !empty($active)) {
        $sql = "UPDATE users
        SET name='$full_name',user_name='$user_name',email='$email',password='$pass',user_image='$image',active='$active'
        WHERE user_id='$id'";

      $stmt = $conn->prepare($sql);
      $stmt->execute();
      echo "<br>" . "User updated success";
    }
}
?>
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php '_PHP_SELF' ?>" method="post">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" name="f_name" required="required" class="form-control">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="image" class="form-control" type="file" name="user_image" required="required">
											</div>
										</div>
