                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
                       ...
                       <td>{$k['active']}</td>
                       <td>
                       <a href='./editNews.php?id={$k['news_id']}'><img src='./images/edit.png' alt='Edit' name='edit'></a>
                       </td>
                       <td>
                       <a href='./deleteNews.php?id={$k['news_id']}'><img src='./images/delete.png' alt='Delete' name='delete'></a>
                       </td>
                      </tr>";
                       }   
                       ?>
